...
connectionstring = "DATABASE=bludb;HOSTNAME=ea286ace-86c7-4d5b-8580-3fbfa46b1c66.bs2io90l08kqb1od8lcg.databases.appdomain.cloud;PORT=31505;PROTOCOL=TCPIP;UID=jrz00477;PWD=2e1ORUoHykD7rc3l;SECURITY=SSL;"
...
app.config["MAIL_USERNAME"] = 'slakshman664@gmail.com'
app.config['MAIL_PASSWORD'] = 'ybxjidlrnujafaak'
...
def adminhome():
    if "adminmail" in session:
        if request.method == 'POST':
            ...
            account = ibm_db.fetch_assoc(stmt)
            while account != False:
                msg = Message(subject='Job Posting', sender='slakshman664@gmail.com',
